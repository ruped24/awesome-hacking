...
- `Adconnectdump <https://github.com/fox-it/adconnectdump>`_ - Dump Azure AD Connect credentials for Azure AD and Active Directory.
...
- `DeathStar <https://github.com/byt3bl33d3r/DeathStar>`_ - DeathStar is a Python script that uses Empire's RESTful API to automate gaining Domain Admin rights in Active Directory environments using a variety of techniques.
...
- `Inveigh <https://github.com/Kevin-Robertson/Inveigh>`_ - Windows PowerShell ADIDNS/LLMNR/mDNS/NBNS spoofer/man-in-the-middle tool.
...
- `PowerPriv <https://github.com/G0ldenGunSec/PowerPriv>`_ - A Powershell implementation of PrivExchange designed to run under the current user's context. 
...
- `Discover <https://github.com/leebaird/discover>`_ - Custom bash scripts used to automate various penetration testing tasks including recon, scanning, parsing, and creating malicious payloads and listeners with Metasploit.
...
- `PwnXSS <https://github.com/pwn0sec/PwnXSS>`_ - A powerful XSS scanner made in Python.
...
- `MitM <https://bitbucket.org/ruped24/mitm/src/master/>`_ - Simple man-in-the-middle script.
...
- `WCE <https://www.ampliasecurity.com/research/windows-credentials-editor/>`_ - Windows Credentials Editor (WCE) is a security tool to list logon sessions and add, change, list and delete associated credentials.
...
- `HTML5 Security Cheatsheetr <https://html5sec.org/>`_ - HTML5 Security Cheatsheet.
...
- `Packer Fuzzer <https://github.com/rtcatc/Packer-Fuzzer>`_ - A scanning tool for fast and efficient security detection of websites constructed by front-end packaging tools such as Webpack.

- `Parameth <https://github.com/maK-/parameth/>`_ - This tool can be used to brute discover GET and POST parameters.
...
- `SleuthQL <https://github.com/RhinoSecurityLabs/SleuthQL>`_ -  Burp History parsing tool to discover potential SQL injection points. To be used in tandem with SQLmap.
...
- `NAT Slipstreaming <https://github.com/samyk/slipstream>`_ -  Allows an attacker to remotely access any TCP/UDP services bound to a victim machine, bypassing the victim's NAT/firewall (arbitrary firewall pinhole control), just by the victim visiting a website.
- `Phishing-frenzy <https://github.com/pentestgeek/phishing-frenzy>`_ - Ruby on Rails Phishing Framework.
- `Pompa <https://github.com/m1nl/pompa-docker>`_ - Fully-featured spear-phishing toolkit - web front-end.
